...
cor_mrna_copynumber_lasso=read.table(file="corr_mrna_copynumber.txt",header=T,sep="\t")
cor_mrna_methylation_lasso=read.table(file="corr_mrna_methylation.txt",header=T,sep="\t")
cor_mrna_methylationn_lasso=read.table(file="corr_mrna_methylation1.txt",header=T,sep="\t")
cor_mrna_mutation_lasso=read.table(file="corr_mrna_mutation.txt",header=T,sep="\t")
